...
export interface EmailTemplate {
    id: string;
    name: string;
    template_type: 'welcome' | 'verification' | 'password_reset' | 'invoice_paid' | 'invoice_overdue' |
    'event_reminder' | 'calculation_approved' | 'calculation_rejected' |
    'document_shared' | 'case_assigned' | 'case_deadline' |
